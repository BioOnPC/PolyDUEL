...
for(var i = 0; i < array_length(Hurtboxes); i++){
	draw_rectangle(x + Hurtboxes[i].XOffset * dir - Hurtboxes[i].Width / 2, 
		y - Hurtboxes[i].YOffset, 
		x + Hurtboxes[i].XOffset * dir + Hurtboxes[i].Width / 2, 
		y - Hurtboxes[i].YOffset - Hurtboxes[i].Height, 0);
	draw_set_alpha(0.8);
	draw_rectangle(x + Hurtboxes[i].XOffset - Hurtboxes[i].Width / 2, 
		y - Hurtboxes[i].YOffset * dir, 
		x + Hurtboxes[i].XOffset * dir + Hurtboxes[i].Width / 2, 
...
for(var i = 0; i < array_length(Hitboxes); i++){
	...
	draw_set_alpha(0.4);
	draw_rectangle(x + Hitboxes[i].XOffset * dir - Hitboxes[i].Width / 2, 
		y - Hitboxes[i].YOffset - Hitboxes[i].Height / 2, 
		x + Hitboxes[i].XOffset * dir + Hitboxes[i].Width / 2, 
...
for(var i = 0; i < array_length(UsedHitboxes); i++){
	...
	draw_set_alpha(0.4);
	draw_rectangle(x + UsedHitboxes[i].XOffset * dir - UsedHitboxes[i].Width / 2, 
		y - UsedHitboxes[i].YOffset - UsedHitboxes[i].Height / 2, 
		x + UsedHitboxes[i].XOffset * dir + UsedHitboxes[i].Width / 2, 
